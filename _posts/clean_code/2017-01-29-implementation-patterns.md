...
2. 嵌套的条件语句孕育着错误，用卫语句改写的代码强调了处理请求的先决条件，而不需要用到复杂的控制结构。
3. 卫语句的一个变体是在循环中使用continue语句，意图同样是指出正常和异常处理之间的差别

#### 异常

1. 英尽可能用序列、消息、迭代和条件来表达控制流，但当不使用异常会令主体流的表达变混淆的时候则应使用异常
...
2. 助手方法的目的是暂时隐藏目前不关心的心结，让你得以通过方法的名字来表达意图，从而令大尺度的运算更具可读性
